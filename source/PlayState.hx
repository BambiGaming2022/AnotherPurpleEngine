...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Ohio is not funny anymore', 0.2], //From 0% to 19%
		['Worse', 0.4], //From 20% to 39%
		['Not so sigma', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['Little bit bad', 0.69], //From 60% to 68%
		['Rizzer', 0.7], //69%
		['Holy Fuck Im Jumming', 0.8], //From 70% to 79%
		['Great Job', 0.9], //From 80% to 89%
		['Amazing!', 1], //From 90% to 99%
		['SIGMA!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
